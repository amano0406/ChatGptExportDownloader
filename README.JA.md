...
- URL、Cookie、User-Agent、出力ファイル名の検出
...
3. `設定` を開きます。
4. `データ コントロール` を開きます。
5. `データをエクスポートする` をクリックします。
6. 必要に応じて認証します。
7. OpenAI から `ChatGPT - データのエクスポートが開始されました` というメールが届くことを確認します。
8. しばらく待つと、`ChatGPT - データ エクスポートの準備ができました` というメールが届きます。

### 2. Chrome DevToolsでダウンロード用リクエストを取得する
...
- `cURL (cmd)` の内容をチャット、Issue、ログ、公開場所に貼らないでください。
